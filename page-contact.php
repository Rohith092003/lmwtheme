            ...
            <div class="lmw-contact-grid">
                ...
                <div class="lmw-contact__info">
                    ...
                    <p style="color:var(--lmw-mid-grey);margin:1rem 0 2rem;">
                        <?php esc_html_e( 'Have a question about an order, bespoke styling, or tailored fit consultations? Reach out and our concierge team will assist you promptly.', 'lmw-theme' ); ?>
                    </p>

                    <div class="lmw-contact__details">
                        <?php
                        $phone   = get_theme_mod( 'lmw_store_phone', '+91 (0) 40 2345 6789' );
                        $email   = get_theme_mod( 'lmw_store_email', 'concierge@lmwfashion.com' );
                        $address = get_theme_mod( 'lmw_store_address', "LMW Flagship Atelier\nRoad No. 36, Jubilee Hills\nHyderabad, Telangana 500033" );
                        if ( empty( $phone ) ) {
                            $phone = '+91 (0) 40 2345 6789';
                        }
                        if ( empty( $email ) ) {
                            $email = 'concierge@lmwfashion.com';
                        }
                        if ( empty( $address ) ) {
                            $address = "LMW Flagship Atelier\nRoad No. 36, Jubilee Hills\nHyderabad, Telangana 500033";
                        }
                        ?>
